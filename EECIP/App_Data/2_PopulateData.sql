...
('ePermitting','An enterprise-level system that allows the agency to issue permits and authorizations accross multiple programs from a common plateform, often including forms development and regulated entity consolidation.','',3,1,0,GetDate()),
